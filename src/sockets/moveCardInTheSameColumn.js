export const moveCardInTheSameColumnSocket = (socket) => {
  // Lắng nghe sự kiện mà client emit lên
  socket.on("FE_MOVE_CARD_IN_THE_SAME_COLUMN", (data) => {
    ...
    socket.broadcast.emit("BE_MOVE_CARD_IN_THE_SAME_COLUMN", data);
  });
};
